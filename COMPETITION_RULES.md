...
Open items
Should "no relegation, bottom-3 market instead" be described
this precisely somewhere player-facing? Resolved -- no change
needed, current status stands.
Bracket composition and seeding Resolved and simplified.
...
Promotion-market simulation code update Done, and later
...
Not actioned yet, direction narrowed: likely Variant A or B
...
addition on its own.
Document needs a permanent home Committed -- see below.
