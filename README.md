...
See `COMPETITION_RULES.md` for the full promotion, relegation, playoff, and
charity-promotion rules -- extracted and verified directly against the
actual simulation code, the reference to check before changing any of that
logic.
...
1. Go to **supabase.com**, sign up (free tier is plenty for this), and
   create a new project.
2. In your project, open **SQL Editor -> New query**, paste in the entire
...
4. Open `js/app.js` and find these two lines near the top:
   ```js
...
1. Go to **github.com**, log in, and click the **+** in the top right →
   **New repository**.
2. Name it (e.g. `bilbbet`), leave it Public or Private as you prefer,
   and click **Create repository** (don't add a README/gitignore here --
   you already have one).
3. On the empty repo page, click **uploading an existing file**.
4. Drag in `index.html`, then create the folder structure by typing the
...
3. GitHub gives you a URL like `https://<username>.github.io/bilbbet/`
